...
class TestInvalidCheckout:
    ...
    # test_invalid_checkout_information() navigates to checkout page, fills in some details and clicks continue
    # This throws an error message,when required checkout information is missing.
    def test_invalid_checkout_information(self):

        # Reads the Keywords in CSV file
        keywords = read_keywords('../Data/keywords_08_error_checkout.csv')
        ...
        for step in keywords:
            ...
            # For checkout keyword it calls method(arg1, arg2, arg3) including empty data
            if keyword=="checkout":
