...
class TestAddToCart:
    ...
    # test_add_to_cart() navigates to inventory page and after selecting items, it adds to cart
    # Also this displays the added cart items and cart count
    def test_add_to_cart(self):

        # Reads the Keywords in CSV file
        keywords = read_keywords('../Data/keywords_06_add_to_cart.csv')
