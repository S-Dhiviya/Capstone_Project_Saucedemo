...
class TestCompleteCheckout:
    ...
    # test_complete_checkout() completes the checkout information and takes screenshot of order summary
    # After clicking finish it displays the confirmation message of order
    def test_complete_checkout(self):

        # Reads the Keywords in CSV file
        keywords = read_keywords('../Data/keywords_08_complete_checkout.csv')
