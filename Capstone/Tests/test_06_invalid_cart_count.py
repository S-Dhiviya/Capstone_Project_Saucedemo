...
class TestInvalidCartCount:

    # test_invalid_cart_count() navigates to inventory page and after selecting items, it adds to cart
    # Also this displays the added cart items and asserts the cart count==4
    def test_invalid_cart_count(self):

        # Reads the Keywords in CSV file
        keywords = read_keywords('../Data/keywords_06_invalid_cart_count.csv')
